      ...
      <div className={styles.cardSection}>
        ...
        <div className={styles.pfizerInfo}>
          ...
          <ul>
            ...
            <li>ผู้ที่มีโรคประจำตัวที่อาจส่งผลให้อาการรุนแรงหากติดเชื้อ<br/>โควิด-19 เช่น ความดันโลหิตสูง เบาหวาน โรคหอบหืด โรคปอด โรคตับ โรคไต และโรคติดเชื้อเรื้อรังอื่นๆ</li>
