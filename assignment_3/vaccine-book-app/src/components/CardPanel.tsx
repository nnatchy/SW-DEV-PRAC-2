...
export default function CardPanel() {
    ...
    const ratingReducer = (ratingList: Map<string, number>, action: { type: string, hospitalName: string, hospitalRating: number }) => {
        switch (action.type) {
            case 'add': {
    ...
    return (
        <div className="block">
            <div className="flex flex-row space-x-[50px] mt-[30px]">
                <Card hospitalName='Chulalongkorn Hospital' imgSrc='/img/chula.jpg' hospitalSrc="https://chulalongkornhospital.go.th/kcmh/"
                ...
                <Card hospitalName='Rajavithi Hospital' imgSrc='/img/rajavithi.jpg' hospitalSrc="https://www.rajavithi.go.th/"
                    onClickRating={(scoreRating: number) => dispatchRating({ type: "add", hospitalRating: scoreRating, hospitalName: "Rajavithi Hospital" })}
                    ratingList={ratingList} />
                <Card hospitalName='Thammasat University Hospital' imgSrc='/img/thammasat.jpg' hospitalSrc="https://www.hospital.tu.ac.th/"
