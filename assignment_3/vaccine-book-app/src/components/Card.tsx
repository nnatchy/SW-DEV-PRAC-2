...
export default function Card({ hospitalName, imgSrc, hospitalSrc, onClickRating, ratingList }: { hospitalName: string, imgSrc: string, hospitalSrc: string, onClickRating: Function, ratingList: Map<string, number> }) {
        ...
        <InteractiveCard contentName={hospitalName}>
            <div className={`${styles.card} w-[420px] h-[600px] mx-0`}>
                ...
                <div className={`${styles.cardText} h-[15%]`}>
                    <div className={`indent-0 font-bold text-[25px] pt-[10px] text-center`}>
                        {hospitalName}
                    </div>
